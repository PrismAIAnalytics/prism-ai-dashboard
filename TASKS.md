...
|---------|-------|--------|-------|---------|
| T-019 | Build Notion → CRM Ticket Sync (Notion `Prism AI Tickets` DB → dashboard `tickets`, polling every 5 min). Tracks PRISM-2 in Notion. | `task/notion-to-crm-sync` | Claude Code | 2026-04-30 09:29 |
